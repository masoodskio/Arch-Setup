...
#Feel free to use it however this is provided without any warranties
...
"Do you want use the default time zone(America/Chicago)?.\n\nPress no for select your own time zone" 
10 60 && echo "America/Chicago" > tz.tmp || tzselect > tz.tmp
